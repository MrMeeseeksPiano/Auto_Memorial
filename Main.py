...
gerador_gokin_700 = {'Fabricante': 'GOKIN SOLAR','SIGLA': 'GK-2-66HTBD-700M','Tec_construcao': 'Monocristalino N-Type TOPCon Dual Glass (Bifacial)','Garantia': '12 anos','Pot_max': '700 W','Eficiencia': '22,50 %','Tensao_nom': '41,10 V','Tensao_aberto': '47,90 V','Corrente_nom': '17,04 A','Corrente_cc': '18,08 A','axlxp': '2384 x 1303 x 33 mm','Peso': '37,1 kg','Imagem_gerador': 'Imagens/Trina_gerador.jpg'}
...
opcoes_mod = ["Trina Solar", "Canadian Solar", "Astronergy 375W", "Gokin 585W", "Hanersun 585W", "Gokin 700W", "Astronergy 600W", "ZnShine 700W", "Hanersun 610W", "Honor 700W", "Gokin 700W"]
mod_sel = st.selectbox("Escolha o tipo de módulo:", opcoes_mod)
tipo_mod = opcoes_mod.index(mod_sel) + 1

opcoes_inv = ["Growatt NEO 2250M-X2", "Sungrow", "Hoymiles MI-1500/700", "Hyxipower", "Solis 6 kW", "Hoymiles HMS-2000-4T", "Growatt NEO 2000M-X", "SAJ R6-20K-T3-32-LV"]
...
if arquivo_pdf:
    ...
    if tipo_mod == 1:
        ...
        dicionario.update(gerador_gokin_700)
        gerador_escolhido = gerador_gokin_700
        imagem_gerador_placeholder = gerador_gokin_700['Imagem_gerador']
